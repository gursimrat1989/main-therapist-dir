...
@section('content')
    ...
    <div class="row mt-2 mb-2">
        <div class="col-lg-12">
        	...
        	<h2 class="relative heading-title-outer">Add Article
	    	...
	    	<div class="row">
		        ...
		        <div class="col-md-12">
                    ...
                    <!--<div class="form-group">
                        ...
                        {{ Form::select('category_id', $blogCategories, null, ['multiple'=>'multiple','class' => 'form-control']) }}
                    </div>-->
		        	...
		        	<div class="form-group">
		        	    ...
		        	    <textarea class="form-control gss-rich-editor" name="description" required="">{{ old('description') }}</textarea>
		        	</div>

                    <div class="form-group">
		        	    <label for="pwd">Featured Image:</label>
		        	    <input type="file" name="featured_image" class="form-control no-padding" id="featured-image">
		        	</div>
		        	...
		        	<div class="form-group">
		        	    <input type="submit" value="Add Article" class="form-control btn btn-success submit-button">
		        	</div>
